...
export function useProduct_Card_2_Cb() {
	const onClick = useCallback(callbackFactory("Product_Card_2_", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useProduct_Name_1_Cb() {
	const onClick = useCallback(callbackFactory("Product_Name_1_", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
